            ...
            <div class="row cards">
                <div class="col-lg-4  col-md-8  offset-md-2  offset-lg-0">
                    ...
                    desc="Решения для многоквартирных домов." actiontext="Начать">
                        <img src="../../assets/flat.jpg" srcset="../../assets/flat.jpg 1x, ../../assets/flat@2x.jpg 2x"/>
                    </card>
                </div>
                ...
                <div class="col-lg-4  col-md-8  offset-md-2  offset-lg-0">
                    ...
                    desc="Решения для частных домов с постоянным отоплением." actiontext="Начать">
                        <img src="../../assets/house.jpg" srcset="../../assets/house.jpg 1x, ../../assets/house@2x.jpg 2x"/>
                    </card>
                </div>
                ...
                <div class="col-lg-4  col-md-8  offset-md-2  offset-lg-0">
                    ...
                    desc="Решения для загородного дома с сезонным отоплением." actiontext="Начать">
                        <img src="../../assets/dacha.jpg" srcset="../../assets/dacha.jpg 1x, ../../assets/dacha@2x.jpg 2x"/>
                    </card>
                </div>
            </div>
        </template>
